          ...
          <Card>
            <CardHeader className="text-center">
              <CardTitle className="text-xl">
                ¡Hola! ¡Estás invitado a unirte a un espacio de trabajo de TeamSync.!
              </CardTitle>
              <CardDescription>
                Parece que necesitas estar conectado a tu cuenta de TeamSync. para
