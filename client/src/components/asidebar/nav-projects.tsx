...
export function NavProjects() {
  ...
  // 1. CORRECCIÓN: Extraemos setOpenMobile aquí
    ...
    <>
      <SidebarGroup className="group-data-[collapsible=icon]:hidden">
        ...
        <SidebarMenu className="h-[320px] scrollbar overflow-y-auto pb-2">
          {isError ? <div>Ocurrió un error</div> : null}
          {isPending ? (
            <Loader
              className=" w-5 h-5
             animate-spin
          ...
          {!isPending && projects?.length === 0 ? (
            <div className="pl-3">
              <p className="text-xs text-muted-foreground">
                Aún no hay proyectos en este espacio de trabajo. Los proyectos
                que crees aparecerán aquí.
              </p>
              <PermissionsGuard requiredPermission={Permissions.CREATE_PROJECT}>
                <Button
                  variant="link"
              ...
              return (
                <SidebarMenuItem key={item._id}>
                  <SidebarMenuButton
                    ...
                    // 2. CORRECCIÓN: Cierra el menú al hacer clic en el nombre
                  ...
                  <DropdownMenu>
                    ...
                    >
                      <DropdownMenuItem
                        onClick={() => {
                          navigate(`${projectUrl}`);
                          // 3. CORRECCIÓN: Cierra el menú al hacer clic en "Ver Proyecto"
          ...
          {hasMore && (
            <SidebarMenuItem>
              ...
              >
                ...
                <span>{isFetching ? "Cargando..." : "Más"}</span>
              </SidebarMenuButton>
            </SidebarMenuItem>
          )}
        </SidebarMenu>
