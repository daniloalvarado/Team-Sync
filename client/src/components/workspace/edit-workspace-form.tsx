                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        ...
                        className="!h-[48px] disabled:opacity-90 dark:text-[#f1f7feb5] disabled:pointer-events-none"
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        rows={6}
                        disabled={!canEditWorkspace}
                        className="disabled:opacity-90 dark:text-[#f1f7feb5] disabled:pointer-events-none"
                        placeholder="Nuestro equipo organiza proyectos y tareas aquí."
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
